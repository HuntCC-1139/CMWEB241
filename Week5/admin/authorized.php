...
<html>
  <head>
    <title>Photo Gallery-Authorized Log File </title>
...
<!-- end header.php --> 
    ...
    <div id="main">
        ...
        <h1>Authorized Log File</h1>
        <br>
        <p><a href="../index.php">Photo Gallery</a></p>
        <p><a href="admin.php">Admin Menu</a></p>
        <p></p><a href="deleteAuthorized.php">Clear Authorized Log File</a></p>
        <br>
        
         <?php
         $logfile=fopen("authorized.txt", "r");
         while(! feof($logfile))
         {
